...
export const metadata = { title: "Advertise | Awaaz Bharti" };
    ...
    <div className="bg-slate-50 min-h-screen flex flex-col">
      ...
      <main className="flex-1 max-w-3xl w-full mx-auto px-5 py-14">
        ...
        <div className="bg-white rounded-2xl p-8 shadow-sm border border-slate-100 space-y-5 text-gray-600 leading-relaxed">
          <p>
            Reach millions of engaged readers across India with targeted advertising on Awaaz Bharti. We offer display ads, sponsored content, video placements, and custom brand partnerships.
          </p>
          <p>
          ...
          <p>
            ...
            <span className="font-semibold text-gray-800">ads@awaazBharti.in</span>
          </p>
        </div>
      </main>
      <Footer />
