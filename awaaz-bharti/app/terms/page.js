...
export const metadata = { title: "Terms of Use | Awaaz Bharti" };
    ...
    <div className="bg-slate-50 min-h-screen flex flex-col">
      ...
      <main className="flex-1 max-w-3xl w-full mx-auto px-5 py-14">
        ...
        <div className="bg-white rounded-2xl p-8 shadow-sm border border-slate-100 space-y-5 text-gray-600 leading-relaxed text-sm">
          ...
          <p>By accessing Awaaz Bharti, you agree to these terms. Please read them carefully.</p>
          <h2 className="text-base font-black text-gray-900">Use of Content</h2>
          <p>All content on this platform is the intellectual property of Awaaz Bharti. You may not reproduce, distribute, or commercially exploit any content without prior written permission.</p>
          ...
          <p>For terms-related queries: legal@awaazBharti.in</p>
        </div>
      </main>
      <Footer />
    </div>
