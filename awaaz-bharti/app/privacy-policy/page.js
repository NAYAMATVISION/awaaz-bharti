...
export const metadata = { title: "Privacy Policy | Awaaz Bharti" };
    ...
    <div className="bg-slate-50 min-h-screen flex flex-col">
      ...
      <main className="flex-1 max-w-3xl w-full mx-auto px-5 py-14">
        ...
        <div className="bg-white rounded-2xl p-8 shadow-sm border border-slate-100 space-y-5 text-gray-600 leading-relaxed text-sm">
          ...
          <p>Awaaz Bharti (&quot;we&quot;, &quot;our&quot;, &quot;us&quot;) is committed to protecting your privacy. This policy explains how we collect, use, and safeguard your information when you visit our website.</p>
          ...
          <p>For privacy-related queries, contact us at privacy@awaazBharti.in</p>
        </div>
      </main>
      <Footer />
    </div>
