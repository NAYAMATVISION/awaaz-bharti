...
export const metadata = { title: "About Us | Awaaz Bharti" };
    ...
    <div className="bg-slate-50 min-h-screen flex flex-col">
      ...
      <main className="flex-1 max-w-3xl w-full mx-auto px-5 py-14">
        ...
        <div className="bg-white rounded-2xl p-8 shadow-sm border border-slate-100 space-y-5 text-gray-600 leading-relaxed">
          <p>
            <strong className="text-gray-900">Awaaz Bharti</strong> is India&apos;s trusted digital news platform committed to delivering accurate, unbiased, and in-depth coverage of politics, business, technology, sports, and entertainment.
          </p>
          <p>
