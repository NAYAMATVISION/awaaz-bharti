...
export const metadata = { title: "Careers | Awaaz Bharti" };
    ...
    <div className="bg-slate-50 min-h-screen flex flex-col">
      ...
      <main className="flex-1 max-w-3xl w-full mx-auto px-5 py-14">
        ...
        <div className="bg-white rounded-2xl p-8 shadow-sm border border-slate-100 space-y-5 text-gray-600 leading-relaxed">
          <p>
            We are always looking for passionate journalists, editors, video producers, and digital media professionals to join the Awaaz Bharti family.
          </p>
          <p>
          ...
          <p>
            ...
            <span className="font-semibold text-gray-800">careers@awaazBharti.in</span>
          </p>
        </div>
      </main>
      <Footer />
